...
def plot_fog_frequency():
    ...
    for i in [250, 500, 750, 1000]:
        ...
        try:
            ...
            pass
        vc.sort_index(ascending=False).cumsum().sort_index().plot(kind="line", label=f"vis < {i:d}", ax=a)
...
#    a.set_xlim([0, 30])
#    a.set_ylim([0, 150])
    f.canvas.print_figure(plotdir() / "out.png")
